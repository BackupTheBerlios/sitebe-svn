...
*/
	...
	if (!isset($_GET['a']))
	{
		print("\t\t\t<center>[ <a href=\"espacereserve.php?p=connexion&w=etudiants&a=load\"><u>Consulter les fichiers à télécharger</u></a> ] - ") ;
	...
	else
	{
        ...
        $liste = mysql_fetch_array($res);
				...
				print("\t\t\t\t\t<td width=\"600\" align=\"center\"> ");
                                print "Aucun fichier présent pour ce diplome !" ;
                                print("\t\t\t\t</td></tr>\n") ;
			}
	...
	//		copy('http://localhost/iupisi3/Data/Telechargement/Licence 2/05.jpg','C:\05.jpg');
      ...
      else
      {
        ...
        print("\t\t\t\t</tr>\n") ;
        print "<tr><td><input class=\"defaultButton\" type=\"submit\" name=\"addButton\" value=\"Déposer\" ></td></tr>  ";      
        print("\t\t\t\t</table");
      }
    }
		if ($_GET['a'] == "logout")
