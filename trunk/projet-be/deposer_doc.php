<?
	...
	if (isset($_FILES['fichier']))
	{
		...
		{
			print("<td>Le titre du fichier doit &ecirc;tre renseign&eacute;.</td>");
			print("<table cellspacing=\"3\"><tr><td colspan=\"2\"><h2>D&eacute;poser des fichiers</h2></td></tr>");
			print("<form name=\"depotFichier\" method=\"post\" action=\"espacereserve.php?p=connexion&w=".$_GET['w']."&a=dep\" enctype=\"multipart/form-data\">");
