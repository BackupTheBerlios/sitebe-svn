...
{	
	...
	if (!isset($_GET['a']))
	{
		...
		print("[ <a href=\"admin.php?w=enseignements&a=mod\"> modifier enseignement</a> ] - ") ;	
	...
	else
	{
      ...
      /*
			print("\t\t\t\t<tr>\n") ;
			print("\t\t\t\t\t<td width=\"200\" align=\"left\"><b> Identifiant de la mati&egrave;re *</b></td><td width=\"100\" align=\"left\"><input class=\"defaultInput\" name=\"matiere\" size=\"7\" maxlength=\"7\"></td>") ;
			print("<td align=\"right\" width=\"200\"><a href=\"javascript:openHelp('allmatieres')\"> voir les mati&egrave;res</a></td>\n") ;
			print("\t\t\t\t</tr>\n") ;
			*/
			print("\t\t\t\t<tr>\n") ;
		...
		elseif ($_GET['a'] == "mod")
		{
			centeredInfoMessage(3, 3, "Administration des enseignements : modification") ;
			...
			if (!isset($_POST['id']))
			{
				// on ne connait pas encore l'enseignant dont on veut modifier la matiere
				if (!isset($_POST['ensID']))
				{
					print("\t\t\t<center><b>Choisissez l'enseignant dont il faut modifier une mati&egrave;re</b></center><br>\n") ;
					...
					{
						print("\t\t\t<center><form action=\"admin.php?w=enseignements&a=mod\" method=\"post\">\n") ;
						print("\t\t\t<table cellspacing=\"3\" cellpadding=\"0\">\n") ;
						...
						print("\t\t\t\t<tr>\n") ;
						print("\t\t\t\t\t<td width=\"200\" align=\"left\"><br><input class=\"defaultButton\" type=\"submit\" name=\"enseignementMod\" value=\"Choisir\"></td>\n") ;
						print("\t\t\t\t</tr>\n") ;
						print("\t\t\t</table>\n") ;
						print("\t\t\t</form></center>\n") ;
					} // end of else ($ensCount == 0)
				...
				{
					print("\t\t\t<center><b>Choisissez la mati&egrave;re &agrave; modifier</b></center><br>\n") ;
					// liste des matieres
					...
					else
					{
						...
						for ($i = 0 ; $i < $matCount ; $i++)
						{
							...
							print("\t\t\t\t<tr>\n") ;
							print("\t\t\t\t\t<td width=\"600\" align=\"left\"><input type=\"radio\" name=\"id\" value=\"{$fMatList['id-matiere']}\" onClick=\"submit()\"> {$fMatList['intitule']} ({$fMatList['module']}, {$fMatList['diplome']})</td>\n") ;
							print("\t\t\t\t</tr>\n") ;
						}
				
						print("\t\t\t\t<tr>\n") ;
						print("\t\t\t\t\t<td width=\"600\" align=\"left\"><br><input type=\"hidden\" name=\"ensID\" value=\"{$_POST['ensID']}\"><input type=\"hidden\" name=\"enseignant\" value=\"{$_POST['ensID']}\"><input class=\"defaultButton\" type=\"submit\" name=\"enseignementMod\" value=\"Choisir\"></td>\n") ;
						print("\t\t\t\t</tr>\n") ;
						print("\t\t\t</table>\n") ;
						print("\t\t\t</form></center>\n") ;
					} // end of else ($ensCount == 0)
        ...
        print("</select></td></tr>");
	/*			print("\t\t\t\t<tr>\n") ;
				print("\t\t\t\t\t<td width=\"200\" align=\"left\"><b> Identifiant de la mati&egrave;re *</b></td><td width=\"100\" align=\"left\"><input class=\"defaultInput\" name=\"matiere\" size=\"7\" maxlength=\"7\" value=\"{$_POST['id']}\"></td>") ;
				print("<td align=\"right\" width=\"200\"><a href=\"javascript:openHelp('allmatieres')\"> voir les mati&egrave;res</a></td>\n") ;
				print("\t\t\t\t</tr>\n") ;*/
			
				print("\t\t\t\t<tr>\n") ;
				print("\t\t\t\t\t<td width=\"600\" align=\"left\" colspan=\"3\"><br><input type=\"hidden\" name=\"enseignementMod\" value=\"true\"><input type=\"hidden\" name=\"enseignant\"  value=\"{$_POST['enseignant']}\"><input type=\"hidden\" name=\"oldMatiere\" value=\"{$_POST['id']}\"><input class=\"defaultButton\" type=\"button\" name=\"modButton\" value=\"Modifier\" onClick=\"checkEnseignementMod('defaultForm')\"></td>\n") ;
				print("\t\t\t\t</tr>\n") ;
				print("\t\t\t</table>\n") ;
				print("\t\t\t</form></center>\n") ;
			}
