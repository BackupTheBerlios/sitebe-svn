...
if (is_numeric(strpos($_SERVER['PHP_SELF'], "index.php")))
{
	...
	print("\t\t\t\t<tr>\n") ;
	print("\t\t\t\t\t<td id=\"centerTitle\">Navigation &raquo;&nbsp; Espace Réservé ");
...
if (! isset($_SESSION['etuConnecte']) && !isset($_SESSION['ensConnecte']))
{
	...
	else
	{
		...
		if ($connect_result != 0)
		{
                         ...
                         if ($connect_result != 1)
                         {
                                centeredErrorMessage(2, 2, "Erreurs de base de données! Plusieurs utilisateurs possibles!") ;
                         }
		         ...
		         {
		                       	centeredErrorMessage(2, 2, "Paramètres de connexion incorrects, réessayez") ;
		                       	print("\t\t\t<form action=\"index.php?p=connexion\" method=\"post\">\n") ;
		                       	print("\t\t\t<center><table width=\"400\">\n\t\t\t\t<tr>\n") ;
...
else
{
    ...
    if (!isset($_GET['a']))
    {
            ...
            if(isset($_SESSION['ensConnecte']) && $_SESSION['ensConnecte'])
            {
	            ...
	            print("\t\t\t\t<tr>\n") ;
	            print("<td align=\"center\" width=\"400\"><a href=\"index.php?p=connexion&w=enseignants&a=dep\"><u>Déposer des fichiers</u></a></td>") ;
                    print("\t\t\t\t</tr>\n") ;
            ...
            elseif(isset($_SESSION['etuConnecte']) && $_SESSION['etuConnecte'])
            {
	            ...
	            print("\t\t\t\t<tr>\n") ;
	            print("<td align=\"left\" width=\"400\"><a href=\"index.php?p=connexion&w=etudiants&a=load\"><u>Consulter les fichiers à télécharger</u></a></td>") ;
                    print("\t\t\t\t</tr>\n") ;
