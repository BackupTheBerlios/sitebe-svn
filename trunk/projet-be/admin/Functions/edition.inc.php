...
function printEditingTools($formName, $fieldName, $colspan)
{
	...
	print(" <input type=\"button\" class=\"toolButton\" value=\"Souligné\" onClick=\"makeSimpleTag('$formName', '$fieldName', 'u')\">") ;
	print(" <input type=\"button\" class=\"toolButton\" value=\"Barré\" onClick=\"makeSimpleTag('$formName', '$fieldName', 's')\">") ;
